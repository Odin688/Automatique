...
\begin{center}
    ...
    Voici le diagramme de Black expérimental : 
    \begin{center}
        \includegraphics{Diagramme de Black experimental_syst2.png}
    \end{center}
...
\begin{itemize}
    ...
    \item \underline{\itshape Système du $1^{er}$ ordre} : Soit la fonction de transfert du $1^{er}$ ordre $F_1(p) = \frac{A}{1 + \tau p }$. Ici A représente le gain/l'amplification statique et $\tau$ représente la constante de temps (en secondes) du système.
...
\item \underline{\itshape Système du $2^{\grave{e}me}$ ordre} : Soit la fonctionde transfert du $2^{\grave{e}me}$ ordre  $F_2(p) = \frac{A}{1 + 2m\frac{p}{\omega_0} + (\frac{p}{\omega_0})^2}$. 
\end{itemize}
...
\begin{center}
    \includegraphics{Reponse_indicelle_m_sup_1.png}
\end{center}
...
\begin{center}
    \includegraphics{Reponse_indicielle_m_inf_1.png}
\end{center}
...
\begin{center}
    ...
    \begin{center}
        \includegraphics{Carac_stat_1.png}
    \end{center} 
    Grâce à cette caractéristique statique, on peut mesurer l'amplification statique, qui est la pente de la droite dans le domaine de linéarité ($D = \left[-7.4;7.3\right]$), qui est délimité par les pointillés en vert. On voit clairement sur le graphe que $A=2$.
    \\
